...
extern	statetype s_dogcpath3;
extern	statetype s_dogcpath3s;
extern	statetype s_dogcpath4;

extern	statetype s_dogcjump1;
extern	statetype s_dogcjump2;
...
extern	statetype s_dogcdie3;
extern	statetype s_dogcdead;

statetype s_dogcpath1 	= {true,SPR_DOG_W1_1,20,T_CompanionPath,NULL,&s_dogcpath1s};
statetype s_dogcpath1s 	= {true,SPR_DOG_W1_1,5,NULL,NULL,&s_dogcpath2};
statetype s_dogcpath2 	= {true,SPR_DOG_W2_1,15,T_CompanionPath,NULL,&s_dogcpath3};
statetype s_dogcpath3 	= {true,SPR_DOG_W3_1,20,T_CompanionPath,NULL,&s_dogcpath3s};
...
void T_CompanionPath (objtype *ob)
{
    ...
    // TODO Implement SightEnemy, fall back on sighPlayer to re-follow
    if (SightPlayer (ob))
        return;
...
void T_CompanionBite (objtype *ob)
{
    ...
    /* TODO Change to damage enemy actor instead of player
    dx = player->x - ob->x;
    if (dx<0)
        dx = -dx;
    dx -= TILEGLOBAL;
